...
3. Prompt the agent to read the webhook JSON (`issueUrl`, `title`, `body`, `issueNumber`), follow `.cursor/skills/fix-sign-combination/SKILL.md`, use `**[Cursor Agent]**` on all GitHub text, and open a PR linking the issue.
