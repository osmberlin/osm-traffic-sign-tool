  ...
  return (
    <form className="mx-2 mt-2 rounded-sm border border-stone-400/50 p-1 text-sm leading-tight">
      ...
      <input
        ...
        value={value}
        className="block w-full rounded-md border-0 px-1 py-1.5 text-center text-gray-900 shadow-xs ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:leading-6"
      />
    </form>
  )
}
