export const buttonStyle =
  'inline-flex items-center rounded-full border border-transparent bg-violet-600 px-3 py-1.5 text-xs font-regular text-white shadow-xs hover:bg-violet-800 focus:outline-hidden focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 disabled:bg-gray-300 disabled:text-gray-900 disabled:hover:bg-gray-300'

export const buttonStyleSecondary =
  'inline-flex items-center rounded-full border border-violet-50 bg-violet-200 px-3 py-1.5 text-xs font-regular text-violet-700 hover:bg-violet-300 focus:outline-hidden focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 disabled:bg-gray-300 disabled:text-gray-900 disabled:hover:bg-gray-300'
