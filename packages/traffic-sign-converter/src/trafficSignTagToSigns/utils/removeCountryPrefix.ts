 ...
 */
export const removeCountryPrefix = (input: string, countryPrefix: CountryPrefixesType) => {
  return (
    input
 ...
 * @param `countryPrefix` – For example "DE", see `countryPrefixes`
 */
export const removeCountryPrefixes = (input: string[], countryPrefix: CountryPrefixesType) => {
